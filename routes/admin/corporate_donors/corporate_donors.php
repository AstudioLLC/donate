...
Route::prefix('corporate-donors')->name('corporate_donors.')->group(function (Router $router) {
    $controller = 'CorporateDonorsController@';
    ...
    $router->post('is_our_donor/{id}', $controller . 'is_our_donor')->name('is_our_donor')->middleware('check-permission:content');
