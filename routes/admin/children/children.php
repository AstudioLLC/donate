...
Route::prefix('children')->name('children.')->group(function (Router $router) {
    ...
    $router->post('addUnreadSession', $controller . 'addUnreadSession')->name('addUnreadSession')->middleware('check-permission:superadmin|moderator|accountant');
