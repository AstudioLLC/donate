...
var openlogin = document.querySelectorAll('.modal-login');
...
var overlayLogin = document.querySelector('.modal-overlay-login');
...
window.resizeMenu = function () {
  var container_width = parseInt($('.menubar').innerWidth() - $('.sidenav-none').width());
...
var openmodal = document.querySelectorAll('.profileSettings');
...
$('#cabinetHome').click(function () {
  ...
  if ($('.cabinet-home-section:has(*)').length == 0) {
    $(window).scrollTop(0);
    var heightTop = $('header').innerHeight();
...
module.exports = __webpack_require__(/*! C:\OpenServer\domains\admin.astudio.laravel\resources\js\script.js */"./resources/js/script.js");
