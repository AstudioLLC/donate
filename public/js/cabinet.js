...
$(document).ready(function () {
  ...
  $('.order-date-id').on('click', function () {
    ...
    var orderDate = $(this).attr('data-id');
...
module.exports = __webpack_require__(/*! C:\OpenServer\domains\admin.astudio.laravel\resources\js\cabinet.js */"./resources/js/cabinet.js");
