...
var BasketCalculatorClass = function BasketCalculatorClass() {
  ...
  self.calculateOrderForm = function () {
    ...
    var deliveryPrice = parseInt(deliveryElement.find('option:selected').attr('data-price'));
...
module.exports = __webpack_require__(/*! C:\OpenServer\domains\admin.astudio.laravel\resources\js\basket-calculator.js */"./resources/js/basket-calculator.js");
