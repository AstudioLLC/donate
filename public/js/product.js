...
window.ionRangeSlider = ion_rangeslider__WEBPACK_IMPORTED_MODULE_0___default.a;
...
$.fn.colorSelect = function () {
  ...
  $('.color-select-input').find('option').each(function () {
    colorItems += '' + '<li class="w-10 h-10 block pointer relative shadow-lg m-1 px-3 py-2 ' + ($(this).prop('selected') ? 'active' : '') + '" style="background:' + this.dataset.color + '" data-colorVal="' + this.dataset.color + '" title="' + this.text + '" data-color-filter="' + this.value + '">' + '<span class="invisible"><i class="fa fa-check" aria-hidden="true"></i></span>' + '</li>';
  ...
  $('.color-select').html("<div class=\"color-select\"> <ul class=\"flex flex-wrap\">".concat(colorItems, "</ul></div>"));
};
...
module.exports = __webpack_require__(/*! C:\OpenServer\domains\admin.astudio.laravel\resources\js\product.js */"./resources/js/product.js");
