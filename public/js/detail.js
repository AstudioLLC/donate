...
swiper__WEBPACK_IMPORTED_MODULE_0__["default"].use([swiper__WEBPACK_IMPORTED_MODULE_0__["Autoplay"], swiper__WEBPACK_IMPORTED_MODULE_0__["Pagination"], swiper__WEBPACK_IMPORTED_MODULE_0__["Navigation"], swiper__WEBPACK_IMPORTED_MODULE_0__["EffectFade"], swiper__WEBPACK_IMPORTED_MODULE_0__["Lazy"], swiper__WEBPACK_IMPORTED_MODULE_0__["Thumbs"]]);
window.Swiper = swiper__WEBPACK_IMPORTED_MODULE_0__["default"];
$(function () {
  var galleryImg = $('.gallery-top').innerHeight();
  var gallerysection = galleryImg - 150;
...
var accordionMobile = false;
var accordionBreakpoint = 786;
var accordionElements = $('#tab-section > li');
var charactersMobilMobile = false;
...
window.constructAccordion = function () {
  if ($(window).innerWidth() < accordionBreakpoint && !accordionMobile) {
    ...
    $.each(accordionElements, function () {
      var navId = $(this).children('a').attr('data-id');
      $('#' + navId).appendTo(this);
    });
...
$("#tab-section > li").on('click', function (event) {
  $("#tab-section > li ").each(function () {
    ...
    var aId = $(this).children('a').attr('data-id');
    $('#' + aId).addClass('hidden');
  });
...
$(document).ready(function () {
  jQuery(document).on('click', '.collectionItemChange', function () {
    var wrapperSelector = '#collection-wrapper';
    var loaderElement = '<div class="flex items-center justify-center my-4 w-full"><div class="lds-roller"><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div></div></div>';
...
module.exports = __webpack_require__(/*! C:\OpenServer\domains\admin.astudio.laravel\resources\js\detail.js */"./resources/js/detail.js");
