...
/***/ "./resources/js/favorites-bundle.js":
/*!******************************************!*\
  !*** ./resources/js/favorites-bundle.js ***!
  \******************************************/
/*! no exports provided */
...
var FavoritesBundleClass = function FavoritesBundleClass() {
  'use strict';
  ...
  self.initTriggersActives = function () {
    ...
    self.favoriteItems.forEach(function (itemId) {//self.favoriteActionElements.find('[data-item-id='+itemId+']').addClass('active');
    });
  };

  if (!window.customConfig.userAuthenticated
  /* || window.customConfig.userIsAdmin*/
  ) {
      return false;
    }

  self.animateAdding = function (element) {
    var cart = $('.favorite-icon');
  ...
  self.fetchFavorites = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
    var response;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return fetch(self.fetchFavoritesUrl);
          ...
          case 5:
            self.favoriteItems = _context.sent;
  ...
  self.addFavorite = /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 3;
              return fetch(self.addFavoriteUrl, {
                method: 'POST',
                mode: 'cors',
                cache: 'no-cache',
  ...
  self.removeFavorite = /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 3;
              return fetch(self.removeFavoriteUrl, {
                method: 'DELETE',
                mode: 'cors',
                cache: 'no-cache',
                credentials: 'same-origin',
  ...
  self.fetchFavorites().then(function () {
    self.initTriggersActives();
  });
  $(document).on('click', self.favoriteActionElementSelector, function () {
    ...
    if (itemId && self.favoriteItems.indexOf(itemId) === -1) {
      self.addFavorite(itemId).then(function () {
        self.initTriggersActives();
        $(_this).addClass('active');
        self.animateAdding($(_this).closest('.item-card'));
      });
    } else {
      self.removeFavorite(itemId).then(function () {
        self.initTriggersActives();
...
/***/ 10:
/*!************************************************!*\
  !*** multi ./resources/js/favorites-bundle.js ***!
  \************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\OpenServer\domains\rv-comfort\resources\js\favorites-bundle.js */"./resources/js/favorites-bundle.js");
