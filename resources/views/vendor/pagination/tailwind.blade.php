        ...
        <a href="{{ $paginator->previousPageUrl() }}" class="prev disabled">
            <svg xmlns="http://www.w3.org/2000/svg" width="7" height="11" viewBox="0 0 7 11">
                <g transform="translate(104.141 -0.001) rotate(90)">
                    <path d="M5.5,104.141a.73.73,0,0,1-.545-.252l-4.73-5.28a.932.932,0,0,1,0-1.216.715.715,0,0,1,1.089,0L5.5,102.065l4.185-4.672a.715.715,0,0,1,1.089,0,.932.932,0,0,1,0,1.216l-4.73,5.28A.729.729,0,0,1,5.5,104.141Z" transform="translate(0)" fill="#0a0a0a"/>
                </g>
            </svg>
        </a>
        <ol>
        ...
        <a href="{{ $paginator->nextPageUrl() }}" class="next">
            <svg xmlns="http://www.w3.org/2000/svg" width="7" height="11" viewBox="0 0 7 11">
                <g transform="translate(7) rotate(90)">
                    <path d="M5.5,0a.73.73,0,0,0-.545.252L.226,5.532a.932.932,0,0,0,0,1.216.715.715,0,0,0,1.089,0L5.5,2.076,9.685,6.748a.715.715,0,0,0,1.089,0,.932.932,0,0,0,0-1.216L6.045.252A.729.729,0,0,0,5.5,0Z" fill="#0a0a0a"/>
                </g>
            </svg>
        </a>
    </div>
