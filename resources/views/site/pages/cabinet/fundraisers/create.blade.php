                        ...
                        <div class="row mt-4">
                            @foreach($fundraisers as $item)
                                <div class="col-12 col-sm-6 p-3 open-createFundraiserPopup"
                                     data-id="{{ $item->id }}"
                                     data-url="{{ route('fundraisers.detail', ['url' => $item->url ?? null]) }}">
                                    <a href="javascript:void(0){{--{{ route('fundraisers.detail', ['url' => $item->url ?? null]) }}--}}" class="profile-fundraiser-card d-flex flex-column text-decoration-none h-100">
