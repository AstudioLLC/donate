...
@section('content')
    ...
    <div class="row m-0 our-grand-programs-section">
        <div class="col-12 col-lg-7 p-0 our-grand-programs-orange">
            <div class="our-grand-programs-container">
                <div class="our-grand-programs-des editor">
                    {!! $page->content !!}
                </div>
            </div>
            <img src="{{asset('images/orange-bg.png')}}" alt="" class="w-100">
        </div>
        <div class="col-12 col-lg-5 p-0 our-grand-programs-img">
