            ...
            <div class="row">
                <div class="col-12 col-lg-6 p-lg-4">
                    <div class="about-text-content">
                        <div class="text-orange" style="text-align: right">
                            {{ $item->title }}
                        </div>
                        <div class="donate-pic-group">
                            @if($item->icon)
                                <div class="donate-pic" style="text-align: right">
                                    <img class="img-fluid"
                            ...
                            @endif
                            @if($item->count)
                                <div class="about-number" style="text-align: right">
                                    {{ $item->count }}
                                </div>
                            @endif
                        </div>
                        @if($item->small_title)
                            <div class="about-number-text-orange" style="text-align: right">
                                {{ $item->small_title }}
                            </div>
                        @endif
                        <div class="editor">
