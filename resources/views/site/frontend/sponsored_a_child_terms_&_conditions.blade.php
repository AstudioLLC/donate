        ...
        <div class="container-small">
            <div class="step-pages-construction d-flex flex-column">
                ...
                <div class="step-white-block-wrap w-100 d-flex justify-content-center align-items-center">
                    <form class="w-100 step-white-block d-flex flex-column justify-content-center align-items-center" id="sponsored-child-terms-and-conditions-form" action="/" method="POST">
