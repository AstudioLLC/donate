                            ...
                            <div class="col-12 col-md-6 col-right">
                                <div class="white-group-main">
                                    <span class="step-group-names d-flex align-items-center">
                                        Recurring payment
                                        <img class="img-fluid information" src="{{ asset('images/information.svg') }}" alt="" title="">
                                    </span>

                                    <div class="step-group step-group-right">
                                        step-group-names d-flex align-items-center              <label class="text-default custom-radio"><input name="recurring-payment" type="radio" value=">automatic"><span>Automatic</span></label>
