...
@section('content')
            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    <div class="col-lg-12 col-12 text-right">
                        <a href="{{ route('admin.donations.index') }}" class="btn btn-sm btn-neutral">
                            {{ __('app.Donations') }}
                        </a>
                    </div>
                </div>
            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="table-responsive p-4">
                        @include('admin.pages.donations.trash._table', ['items' => $items ?? null])
                    </div>
                </div>
    ...
    @include('admin.pages.donations.trash._script')
@endsection
