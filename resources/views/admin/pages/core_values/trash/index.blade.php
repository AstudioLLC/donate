...
@section('content')
            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    <div class="col-lg-12 col-12 text-right">
                        <a href="{{ route('admin.core_values.index') }}" class="btn btn-sm btn-neutral">
                            {{ __('app.Our Core Values') }}
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="table-responsive p-4">
                        @include('admin.pages.core_values.trash._table', ['items' => $items ?? null])
                    </div>
                </div>
    ...
    @include('admin.pages.core_values.trash._script')
@endsection
