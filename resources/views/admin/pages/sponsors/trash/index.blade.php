...
@section('content')
            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    <div class="col-lg-12 col-12 text-right">
                        <a href="{{ route('admin.sponsors.index') }}" class="btn btn-sm btn-neutral">
                            {{ __('app.Sponsors') }}
                        </a>
            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="table-responsive p-4">
                        @include('admin.pages.sponsors.trash._table', ['items' => $items ?? null])
                    </div>
                </div>
    ...
    @include('admin.pages.sponsors.trash._script')
@endsection
