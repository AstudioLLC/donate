...
@section('content')
            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    <div class="col-lg-12 col-12 text-right">
                        <a href="{{ route('admin.report.create', ['file' => $file, 'key' => $key]) }}" class="btn btn-sm btn-neutral">
                            {{ __('app.Create') }}
                        </a>
                    </div>
                </div>
            ...
            <div class="col">
                <div class="card">
                    <div class="card-header border-0">
                        <h3 class="mb-0">Reports | {{$child->child_id}}</h3>
                    </div>
                    <div class="table-responsive p-4">
                        @include('admin.pages.report._table', ['items' => $items ?? null])
                    </div>
                </div>
    ...
    @include('admin.pages.report._script')
@endsection
