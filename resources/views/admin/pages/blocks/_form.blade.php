...
<form action="{!! $edit ? route('admin.blocks.edit', ['id' => $item->id]) : route('admin.blocks.store') !!}" method="post" enctype="multipart/form-data">
    @csrf
    ...
    <div class="row">
            ...
            <div class="form-group border-bottom">
                ...
                <div class="card-body">
                    ...
                    @if (!empty($item->image))
                        ...
                        'action' => route('admin.blocks.deleteImage')
                        ])@endimageDestroy
                    @endif
                </div>
            </div>
        ...
        <div class="col-12 col-lg-6">
            <div class="form-group border-bottom">
                ...
                'id' => 'form_small_title',
                'tp_classes' => 'little-p',
                'title' => __('app.Form.Small title')])
                <input type="text"
                       name="small_title[{!! $iso !!}]"
                       class="form-control form-control-sm form-control-alternative{{ $errors->has('small_title') ? ' is-invalid' : '' }}"
                       placeholder="{{ __('app.Form.Small title') }}"
                       value="{{ old('small_title.'.$iso, tr($item, 'small_title', $iso)) }}">
