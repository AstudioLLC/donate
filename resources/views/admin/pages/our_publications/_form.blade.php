...
<form action="{!! $edit ? route('admin.our_publications.edit', ['id' => $item->id]) : route('admin.our_publications.store') !!}" method="post" enctype="multipart/form-data">
    @csrf
            ...
            <div class="form-group border-bottom">
                ...
                <div class="card-body">
                    ...
                    @if (!empty($item->imageBig))
                        ...
                        'action' => route('admin.our_publications.deleteImage')
                        ])@endimageDestroy
                    @endif
                </div>
            </div>
