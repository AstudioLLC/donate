@push('js')
    <script>
        ...
        /**
         * Item unlimit changer
         */
        $('.unlimit-changer span').on('click', function () {
            ...
            let url = "{!! route('admin.fundraisers.unlimit', ['id' => ':slug']) !!}";
        ...
        $('.active-changer span').on('click', function () {
            ...
            let url = "{!! route('admin.fundraisers.active', ['id' => ':slug']) !!}";
            var thisItemId = $(this).parents('tr').data('id');
        ...
        $('#itemDeleteForm').on('submit', function() {
            ...
            if (thisItemId && thisItemId.match(/^[1-9][0-9]{0,9}$/)) {
                ...
                let url = "{!! route('admin.fundraisers.delete', ['id' => ':slug']) !!}";
