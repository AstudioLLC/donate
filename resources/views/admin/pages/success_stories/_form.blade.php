...
<form action="{!! $edit ? route('admin.success_stories.edit', ['id' => $item->id]) : route('admin.success_stories.store') !!}" method="post" enctype="multipart/form-data">
    @csrf
    ...
    <div class="row">
            ...
            <div class="form-group border-bottom">
                ...
                <div class="card-body">
                    ...
                    @if (!empty($item->imageBig))
                        ...
                        'action' => route('admin.success_stories.deleteImage')
                        ])@endimageDestroy
                    @endif
                </div>
                <div class="col-md-12 mb-2">
                    <img id="preview-image2" src="https://www.escj.org/sites/default/files/default_images/noImageUploaded.png"
        ...
        <div class="col-12 col-lg-6">
            ...
            <div class="form-group border-bottom">
                ...
                <div class="col-md-12 mb-2">
                    <img id="preview-image" src="https://www.escj.org/sites/default/files/default_images/noImageUploaded.png"
                         style="max-height: 250px;">
                </div>
            </div>
            <div class="form-group border-bottom">
        ...
        <div class="form-group border-bottom">
            @formTitle(['title' => __('app.List.Page')])@endformTitle
            <div class="card-body">
                <select name="page_id" id="page_id" class="form-control form-control-sm form-control-alternative">
                    @itemsAllList(['items' => $pages, 'parentId' => $item->page_id ?? null, 'item' => $item, 'delimiter' => '-', 'childsShow' => true])@enditemsAllList
                </select>
...
@push('js')
    <script>
        ...
        $('#imageBig').change(function(){

            let reader2 = new FileReader();
            reader2.onload = (s) => {
                $('#preview-image2').attr('src', s.target.result);
            }
