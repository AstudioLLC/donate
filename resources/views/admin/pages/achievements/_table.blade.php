<table class="table align-items-center table-flush" id="datatable-basic">
    ...
    <tbody class="list table-sortable" data-action="{{ route('admin.achievements.sort') }}">
        ...
        <tr data-id="{{ $item->id }}" class="item-row">
            ...
            <td class="text-right">
                {{--<a class="btn btn-sm btn-icon-only btn-outline-info"
                   href="{{ route('admin.achievements.show', ['id' => $item->id]) }}"
                   title="{{ __('app.View') }}">
                    <i class="fas fa-eye"></i>
                </a>--}}

                <a class="btn btn-sm btn-icon-only btn-outline-primary"
                   href="{{ route('admin.achievements.edit', ['id' => $item->id]) }}"
                   title="{{ __('app.Edit') }}">
