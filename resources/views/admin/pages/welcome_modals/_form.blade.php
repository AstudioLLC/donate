...
<form action="{!! $edit ? route('admin.welcome_modals.edit', ['id' => $item->id]) : route('admin.welcome_modals.store') !!}" method="post" enctype="multipart/form-data">
    @csrf
            ...
            <div class="form-group border-bottom">
                ...
                <div class="card-body">
                    ...
                    @if (!empty($item->image))
                        ...
                        'action' => route('admin.welcome_modals.deleteImage')
                        ])@endimageDestroy
                    @endif
                </div>
            </div>
