...
@section('content')
            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    <div class="col-lg-12 col-12 text-right">
                        <a href="{{ route('admin.regions.index') }}" class="btn btn-sm btn-neutral">
                            {{ __('app.Regions') }}
                        </a>
                    </div>
                </div>
            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="table-responsive p-4">
                        @include('admin.pages.regions.trash._table', ['items' => $items ?? null])
                    </div>
                </div>
    ...
    @include('admin.pages.regions.trash._script')
@endsection
