...
{{--        <div class="col-12">--}}
{{--            <div class="form-group border-bottom">--}}
{{--                @formTitle(['title' => 'Mobile Image' . $imageSmallSize])@endformTitle--}}
{{--                <div class="card-body">--}}
{{--                    @file(['name'=>'mobile_image'])@endfile--}}
{{--                    @if (!empty($item->mobile_image))--}}
{{--                        <div class="border">--}}
{{--                            <img src="{{asset('storage/media/sliders/thumbnail/')}}/{{$item->mobile_image}}" class="img-fluid img-center p-2">--}}
{{--                        </div>--}}
{{--                        <input type="hidden" name="old_mobile_image" value="{{ $item->mobile_image }}">--}}
{{--                        @imageDestroy([--}}
{{--                        'id' => $item->id,--}}
{{--                        'title' => __('app.Delete image'),--}}
{{--                        'action' => route('admin.sliders.deleteImage')--}}
