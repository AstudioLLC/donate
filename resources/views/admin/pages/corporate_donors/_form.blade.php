...
<form action="{!! $edit ? route('admin.corporate_donors.edit', ['id' => $item->id]) : route('admin.corporate_donors.store') !!}" method="post" enctype="multipart/form-data">
    @csrf
            ...
            <div class="form-group border-bottom">
                ...
                <div class="card-body">
                    ...
                    @if (!empty($item->image))
                        ...
                        'action' => route('admin.corporate_donors.deleteImage')
                        ])@endimageDestroy
                    @endif
                </div>
            </div>
