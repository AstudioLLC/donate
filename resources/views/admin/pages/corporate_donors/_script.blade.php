@push('js')
    <script>
        ...
        $('.active-changer span').on('click', function () {
            ...
            let url = "{!! route('admin.corporate_donors.active', ['id' => ':slug']) !!}";
        ...
        $('.is_our_donor-changer span').on('click', function () {
            let value = $(this).parent().find('input').val();
            if (value == 1) {
                $(this).parent().find('input').val(0);
            } else {
            ...
            let url = "{!! route('admin.corporate_donors.is_our_donor', ['id' => ':slug']) !!}";
            var thisItemId = $(this).parents('tr').data('id');
        ...
        $('#itemDeleteForm').on('submit', function() {
            ...
            if (thisItemId && thisItemId.match(/^[1-9][0-9]{0,9}$/)) {
                ...
                let url = "{!! route('admin.corporate_donors.delete', ['id' => ':slug']) !!}";
