...
@push('js')
    ...
    <script>
        ...
        const showUrl = '{{ route('admin.faqs.show', ['id' => ':slug']) }}';

        const editTooltip = '{!! __('app.Edit') !!}';
        const editUrl = '{{ route('admin.faqs.edit', ['id' => ':slug']) }}';
        ...
        $('.dataTable').dataTable({
            ...
            ajax: {
                url: '{{ route('admin.faqs.listPortion') }}',
                type: 'POST',
                /*data: function (e) {
        ...
        $(document).on('click', '.active-changer span', function() {
            ...
            let url = "{!! route('admin.faqs.active', ['id' => ':slug']) !!}";
        ...
        $('#itemDeleteForm').on('submit', function () {
            let url = "{!! route('admin.faqs.delete', ['id' => ':slug']) !!}";
            if (blocked) return false;
            blocked = true;
