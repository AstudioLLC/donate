...
{{--                <div class="card-body">--}}
{{--                    @file(['name'=>'imageBig','id' => 'uploadFile'])@endfile--}}
...
{{--                <div class="card-body">--}}
{{--                    @file(['name'=>'imageSmall','id' => 'uploadFileOne'])@endfile--}}
...
{{--                </div>--}}
{{--            </div>--}}
{{--            <div class="row" id="image_previewOne"></div>--}}
...
@push('js')
    <script type="text/javascript">
        $("#uploadFile").change(function(){
            ...
            {
                $('#image_preview').append("<div class='col-12'><img style='width: 100%; padding: 40px' src='"+URL.createObjectURL(event.target.files[i])+"'></div>");
            }
    ...
    <script>
        $("#uploadFileOne").change(function(){
            $('#image_previewOne').html("");
            var total_file=document.getElementById("uploadFileOne").files.length;
            for(var i=0;i<total_file;i++)
            {
                $('#image_previewOne').append("<div class='col-12'><img style='width: 100%; padding: 40px' src='"+URL.createObjectURL(event.target.files[i])+"'></div>");
            }
