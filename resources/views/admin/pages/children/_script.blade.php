...
@push('js')
    ...
    <script>
        ...
        const reportTooltip = '{!! __('app.Reports') !!}';
        const reportUrl = '{{ route('admin.report.index', ['file' => 'children', 'key' => ':slug']) }}';
            ...
            columns: [
                ...
                },*/
                {
                    ...
                    render: function (id, q, row) {
                        ...
                        tools += '<a target="_blank" class="btn btn-sm btn-icon-only btn-outline-primary" ' +
                        ...
                        tools += '<a target="_blank" class="btn btn-sm btn-icon-only btn-outline-default" ' +
                        ...
                        tools += '<a target="_blank" class="btn btn-sm btn-icon-only btn-outline-default" ' +
                            ...
                            'title="' + 'Social story' +' ('+row.files_count+')">' +
                            '<i class="far fa-file"></i>' +
                            '</a>';

                        tools += '<a target="_blank" class="btn btn-sm btn-icon-only btn-outline-default" ' +
                            'href="' + reportUrl.replace(':slug', row.id) + '" ' +
                            'title="' + reportTooltip +' ('+row.reports_count+')">' +
                        ...
                        tools += '<a target="_blank" class="btn btn-sm btn-icon-only btn-outline-danger delete" ' +
        ...
        $(document).on('click', '.addUnreadSession', function() {
            let unread = $(this).data('unread');
            let url = "{!! route('admin.children.addUnreadSession') !!}";
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response) {
                        console.log('unread');
                        window.location.href = "/admin/children/list";
