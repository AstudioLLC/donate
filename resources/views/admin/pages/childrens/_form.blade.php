...
<form action="{!! $edit ? route('admin.childrens.edit', ['id' => $item->id]) : route('admin.childrens.store') !!}" method="post" enctype="multipart/form-data">
    @csrf
            ...
            <div class="form-group border-bottom">
                ...
                <div class="card-body">
                    ...
                    @if (!empty($item->image))
                        ...
                        'action' => route('admin.childrens.deleteImage')
                        ])@endimageDestroy
                    @endif
                </div>
            </div>
