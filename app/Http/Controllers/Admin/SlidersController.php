...
class SlidersController extends AdminBaseController
{
    ...
    public function create()
    {
        ...
        return response()
            ->view('admin.pages.sliders.create', compact('edit', 'backUrl', 'imageSize','imageSmallSize'));
    }
    ...
    public function edit(int $id)
    {
        ...
        return response()
            ->view('admin.pages.sliders.edit', compact('item', 'edit', 'backUrl', 'imageSize','imageSmallSize'));
    }
