...
class NewsController extends AdminBaseController
{
    ...
    public function create()
    {
        ...
        $pages = Page::where('parent_id', 41)->orWhere('static','our_grand_programs')
            ...
            ->get();
        return response()
            ->view('admin.pages.news.create', compact('edit', 'backUrl', 'imageSmallSize', 'imageBigSize','pages'));
    }
    ...
    public function edit(int $id)
    {
        ...
        $pages = Page::where('parent_id', 41)->orWhere('static','our_grand_programs')
            ...
            ->get();
        return response()
            ->view('admin.pages.news.edit', compact('edit', 'backUrl', 'imageSmallSize', 'imageBigSize', 'item','pages'));
    }
