...
class GiftsController extends AdminBaseController
{
    ...
    public function index()
    {
        ...
        return response()
            ->view('admin.pages.gifts.index', compact('items'));
    }
    ...
    {
        $edit = false;
        $backUrl = route('admin.gifts.index');
        ...
        return response()
            ->view('admin.pages.gifts.create', compact('edit', 'backUrl', 'imageSmallSize', 'imageBigSize'));
    }
    ...
    public function edit(int $id)
    {
        ...
        return response()
            ->view('admin.pages.gifts.edit', compact('edit', 'backUrl', 'imageSmallSize', 'imageBigSize', 'item'));
    }
    ...
    public function search(Request $request)
    {
        ...
        return view('admin.pages.gifts.index',compact('items'));
    }
}
